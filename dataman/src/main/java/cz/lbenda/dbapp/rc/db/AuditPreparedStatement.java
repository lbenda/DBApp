...
public class AuditPreparedStatement implements java.sql.PreparedStatement {
  ...
  private AuditPreparedStatement(User user, Auditor auditor, PreparedStatement wrappedStatement, String sql) throws SQLException {
  ...
  public static final AuditPreparedStatement prepareCall(User user, Auditor auditor, Connection connection, String sql) throws SQLException {
  ...
  public static final AuditPreparedStatement prepareStatement(User user, Auditor auditor, Connection connection,
